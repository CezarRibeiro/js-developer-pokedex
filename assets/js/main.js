...
function convertPokemonToLi(pokemon) {
    return `
        <li class="pokemon ${pokemon.type}" onclick="viewDetails(${pokemon.number})" style="cursor: pointer;">
    ...
    return `
        <header class="header_detail">
            <div class="${pokemon.type}">
                <span class="header_detail_name">${pokemon.name}</span>
                <span class="header_detail_id">#${pokemon.number}</span>
            </div>
        </header>
        <main>
